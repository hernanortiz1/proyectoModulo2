    ...
    <>
      <section>
        ...
        <div className="container my-5">
          ...
          <blockquote class="bebasneue mb-0 fst-italic text-center text-secondary">
            "Somos el equipo detrás de GamerZone, desarrolladores apasionados por los videojuegos y la tecnología. Nos
            especializamos en crear el mejor catálogo de juegos con categorías únicas, ofreciendo experiencias gaming
            inolvidables."
          </blockquote>
        </div>
        {/* Fin presentacion */}
